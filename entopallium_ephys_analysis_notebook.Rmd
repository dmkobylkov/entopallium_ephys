...
## Create function "geom_split_violin"
```{r}
...
spikesAllmelt %>% group_by(light) %>% summarise(count = n_distinct(cellName))


#EntVis = read.table(file = "clipboard", sep = "\t", header=TRUE)

#ggplot(EntVis, aes(fill=Response, x=Hemisphere, y=Units, label = Units)) + 
...
kruskal_effsize(data =spontFR, avgFR~light)
kruskal_effsize(data =spontFR, avgFR~paste(spontFR$light,spontFR$hemisph))
...
#ggplot(spontFR,aes(y=avgFR, x=light, fill=light, alpha = hemisph))+
 # facet_grid(.~hemisph)+
  #geom_boxplot()+
#  scale_alpha_discrete(range = c(0.8, 0.4))+
#  ylab("Spontaneous firing rate, spikes/s")+
#  scale_fill_manual(values=c("grey40","red"))+
#  theme_bw(base_size=20)+
#  theme(panel.grid.major = element_blank())


ggplot(spontFR, aes(y=avgFR, x = light,fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#E9B824","#219C90"))+
...
kruskal_effsize(data =spontFR.Bilat, avgFR~light)
kruskal_effsize(data =spontFR.Bilat, avgFR~paste(spontFR.Bilat$light,spontFR.Bilat$hemisph))
...
ggplot(spontFR.Bilat, aes(y=avgFR, x = light, fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  scale_alpha_discrete(range = c(1, 0.4))+
  ylab("Spontaneous firing rate, spikes/s")+
  theme_bw(base_size=20)+
  theme(panel.grid.major = element_blank())
...
kruskal_effsize(data =spikesBilatClean.ContraON, maxONdelta~light)
...
ggplot(spikesBilatClean.ContraON, aes(y=maxONdelta, x = light, fill = light))+
  #facet_grid(.~hemisph)+
  geom_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#949398FF","#F4DF4EFF"))+
  scale_alpha_discrete(range = c(1, 0.4))+
...
kruskal_effsize(data =spikesBilatClean.ContraON, maxBin~light)
kruskal_effsize(data =spikesBilatClean.ContraON, maxBin~hemisph)
...
spikesBilatClean.ContraON$Cut <- cut(spikesBilatClean.ContraON$maxBin, breaks = seq(0, 0.65, 0.05), right = FALSE) 
spikesBilatClean.ContraON.Aggr = spikesBilatClean.ContraON %>% 
  group_by( hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesBilatClean.ContraON.Aggr$n <- ifelse(spikesBilatClean.ContraON.Aggr$hemisph == "Left", -1*spikesBilatClean.ContraON.Aggr$n, spikesBilatClean.ContraON.Aggr$n)

spikesBilatClean.ContraON.Aggr$freq <- ifelse(spikesBilatClean.ContraON.Aggr$hemisph == "Left", -1*spikesBilatClean.ContraON.Aggr$freq, spikesBilatClean.ContraON.Aggr$freq)

ggplot(spikesBilatClean.ContraON.Aggr, aes(x = Cut, y = freq,fill = hemisph)) + 
  geom_bar(data = subset(spikesBilatClean.ContraON.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.ContraON.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.5,0.5)) + 
  xlab("Latency, s")+
...
spikesBilatClean.ContraON.Aggr$n <- ifelse(spikesBilatClean.ContraON.Aggr$light == "Dark", -1*spikesBilatClean.ContraON.Aggr$n, spikesBilatClean.ContraON.Aggr$n)
spikesBilatClean.ContraON.Aggr$freq <- ifelse(spikesBilatClean.ContraON.Aggr$light == "Dark", -1*spikesBilatClean.ContraON.Aggr$freq, spikesBilatClean.ContraON.Aggr$freq)

ggplot(spikesBilatClean.ContraON.Aggr, aes(x = Cut, y = freq,fill = light)) + 
  geom_bar(data = subset(spikesBilatClean.ContraON.Aggr, light == "Light"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.ContraON.Aggr, light == "Dark"), stat = "identity") + 
  scale_fill_manual(values=c("#949398FF","#F4DF4EFF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-250,250)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.5,0.5)) + 
  xlab("Latency, s")+
  ylab("Proportion of units")+
  coord_flip()+
...
kruskal_effsize(data =spikesBilatClean.ContraOFF, maxOFFdelta~light)
kruskal_effsize(data =spikesBilatClean.ContraOFF, maxOFFdelta~paste(spikesBilatClean.ContraOFF$light,spikesBilatClean.ContraOFF$hemisph))
...
ggplot(spikesBilatClean.ContraOFF, aes(y=maxOFFdelta, x = light, fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
...
kruskal_effsize(data =spikesBilatClean.ContraOFF, maxBinOff~light)
kruskal_effsize(data =spikesBilatClean.ContraOFF, maxBinOff~paste(spikesBilatClean.ContraOFF$light,spikesBilatClean.ContraOFF$hemisph))
...
spikesBilatClean.ContraOFF$Cut <- cut(spikesBilatClean.ContraOFF$maxBinOff, breaks = seq(0, max(spikesBilatClean.ContraOFF$maxBinOff+0.25), 0.05), right = FALSE) 

spikesBilatClean.ContraOFF.Aggr = spikesBilatClean.ContraOFF %>% 
  group_by(light, hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesBilatClean.ContraOFF.Aggr$n <- ifelse(spikesBilatClean.ContraOFF.Aggr$hemisph == "Left", -1*spikesBilatClean.ContraOFF.Aggr$n, spikesBilatClean.ContraOFF.Aggr$n)

spikesBilatClean.ContraOFF.Aggr$freq <- ifelse(spikesBilatClean.ContraOFF.Aggr$hemisph == "Left", -1*spikesBilatClean.ContraOFF.Aggr$freq, spikesBilatClean.ContraOFF.Aggr$freq)

ggplot(spikesBilatClean.ContraOFF.Aggr, aes(x = Cut, y = freq,fill = hemisph, alpha = light)) +
  facet_grid(.~light)+
  geom_bar(data = subset(spikesBilatClean.ContraOFF.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.ContraOFF.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  scale_alpha_discrete(range = c(1, 0.4))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.4,0.4)) + 
  xlab("Latency, s")+
  ylab("Proportion of units")+
  coord_flip()+
  theme_bw(base_size=20)+
...
kruskal_effsize(data =spikesBilatClean.IpsiON, maxONdelta~light)
kruskal_effsize(data =spikesBilatClean.IpsiON, maxONdelta~paste(spikesBilatClean.IpsiON$light,spikesBilatClean.IpsiON$hemisph))
...
ggplot(spikesBilatClean.IpsiON, aes(y=maxONdelta, x = light, fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
...
kruskal_effsize(data =spikesBilatClean.IpsiON, maxBin~light)
#kruskal_effsize(data =spikesBilatClean.IpsiON, maxBin~paste(spikesBilatClean.IpsiON$light,spikesBilatClean.IpsiON$hemisph))

ggplot(spikesBilatClean.IpsiON,aes(x=maxBin))+
  geom_bar(aes(y = ..prop..,fill = light), data = subset(spikesBilatClean.IpsiON, light=="Dark"),width=0.045, color="black") +
  geom_bar(aes(y = ..prop..,fill = light), data = subset(spikesBilatClean.IpsiON, light=="Light"),width=0.03, color="black")+
  scale_alpha_discrete(range = c(0.8, 0.4))+
  ylab("Proportion")+
  xlab("Peak latency, s")+
  scale_fill_manual(values=c("grey40","red"))+
...
spikesBilatClean.IpsiON$Cut <- cut(spikesBilatClean.IpsiON$maxBin, breaks = seq(0, max(spikesBilatClean.IpsiON$maxBin+0.025), 0.05), right = FALSE) 

spikesBilatClean.IpsiON.Aggr = spikesBilatClean.IpsiON %>% 
  group_by(light, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesBilatClean.IpsiON.Aggr$n <- ifelse(spikesBilatClean.IpsiON.Aggr$light == "Dark", -1*spikesBilatClean.IpsiON.Aggr$n, spikesBilatClean.IpsiON.Aggr$n)

spikesBilatClean.IpsiON.Aggr$freq <- ifelse(spikesBilatClean.IpsiON.Aggr$light == "Dark", -1*spikesBilatClean.IpsiON.Aggr$freq, spikesBilatClean.IpsiON.Aggr$freq)

ggplot(spikesBilatClean.IpsiON.Aggr, aes(x = Cut, y = freq,fill = light)) +
  geom_bar(data = subset(spikesBilatClean.IpsiON.Aggr, light == "Dark"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.IpsiON.Aggr, light == "Light"), stat = "identity") + 
  scale_fill_manual(values=c("#949398FF","#F4DF4EFF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.4,0.4)) + 
  xlab("Latency, s")+
...
kruskal_effsize(data =spikesBilatClean.IpsiOFF, maxOFFdelta~hemisph)
#kruskal_effsize(data =spikesBilatClean.IpsiOFF, maxBin~paste(spikesBilatClean.IpsiOFF$light,spikesBilatClean.IpsiOFF$hemisph))
...
spikesBilatClean.IpsiOFF$Xgroup = rep("NoGroup", nrow(spikesBilatClean.IpsiOFF))
ggplot(spikesBilatClean.IpsiOFF, aes(y=maxOFFdelta, x = Xgroup, fill = hemisph))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
...
kruskal_effsize(data =spikesBilatClean.IpsiOFF, maxBinOff~hemisph)
#kruskal_effsize(data =spikesBilatClean.IpsiOFF, maxBin~paste(spikesBilatClean.IpsiOFF$light,spikesBilatClean.IpsiOFF$hemisph))
...
spikesBilatClean.IpsiOFF$Cut <- cut(spikesBilatClean.IpsiOFF$maxBinOff, breaks = seq(0, max(spikesBilatClean.IpsiOFF$maxBinOff)+0.025, 0.05), right = FALSE) 
spikesBilatClean.IpsiOFF.Aggr = spikesBilatClean.IpsiOFF %>% 
  group_by( hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesBilatClean.IpsiOFF.Aggr$n <- ifelse(spikesBilatClean.IpsiOFF.Aggr$hemisph == "Left", -1*spikesBilatClean.IpsiOFF.Aggr$n, spikesBilatClean.IpsiOFF.Aggr$n)

spikesBilatClean.IpsiOFF.Aggr$freq <- ifelse(spikesBilatClean.IpsiOFF.Aggr$hemisph == "Left", -1*spikesBilatClean.IpsiOFF.Aggr$freq, spikesBilatClean.IpsiOFF.Aggr$freq)

ggplot(spikesBilatClean.IpsiOFF.Aggr, aes(x = Cut, y = freq,fill = hemisph)) + 
  geom_bar(data = subset(spikesBilatClean.IpsiOFF.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.IpsiOFF.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.3,0.3)) + 
  xlab("Latency, s")+
  ylab("Proportion of units")+
  coord_flip()+
  theme_bw(base_size=20)+
...
kruskal_effsize(data =spikesBilatClean.BilatON, maxONdelta~light)
#kruskal_effsize(data =spikesBilatClean.IpsiOFF, maxBin~paste(spikesBilatClean.IpsiOFF$light,spikesBilatClean.IpsiOFF$hemisph))


ggplot(spikesBilatClean.BilatON,aes(x=maxONdelta, fill=light))+
...
ggplot(spikesBilatClean.BilatON, aes(y=maxONdelta, x = light, fill = light))+
  #facet_grid(.~hemisph)+
  geom_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#949398FF","#F4DF4EFF"))+
...
kruskal_effsize(data =spikesBilatClean.BilatON, maxBin~light)
kruskal_effsize(data =spikesBilatClean.BilatON, maxBin~hemisph)
#kruskal_effsize(data =spikesBilatClean.IpsiOFF, maxBin~paste(spikesBilatClean.IpsiOFF$light,spikesBilatClean.IpsiOFF$hemisph))
...
spikesBilatClean.BilatON$Cut <- cut(spikesBilatClean.BilatON$maxBin, breaks = seq(0, max(spikesBilatClean.BilatON$maxBin)+0.025, 0.05), right = FALSE) 

spikesBilatClean.BilatON.Aggr = spikesBilatClean.BilatON %>% 
  group_by( hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesBilatClean.BilatON.Aggr$n <- ifelse(spikesBilatClean.BilatON.Aggr$hemisph == "Left", -1*spikesBilatClean.BilatON.Aggr$n, spikesBilatClean.BilatON.Aggr$n)

spikesBilatClean.BilatON.Aggr$freq <- ifelse(spikesBilatClean.BilatON.Aggr$hemisph == "Left", -1*spikesBilatClean.BilatON.Aggr$freq, spikesBilatClean.BilatON.Aggr$freq)

ggplot(spikesBilatClean.BilatON.Aggr, aes(x = Cut, y = freq,fill = hemisph)) + 
  geom_bar(data = subset(spikesBilatClean.BilatON.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.BilatON.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.5,0.5)) + 
  xlab("Latency, s")+
...
spikesBilatClean.BilatON.Aggr$n <- ifelse(spikesBilatClean.BilatON.Aggr$light == "Dark", -1*spikesBilatClean.BilatON.Aggr$n, spikesBilatClean.BilatON.Aggr$n)
spikesBilatClean.BilatON.Aggr$freq <- ifelse(spikesBilatClean.BilatON.Aggr$light == "Dark", -1*spikesBilatClean.BilatON.Aggr$freq, spikesBilatClean.BilatON.Aggr$freq)

ggplot(spikesBilatClean.BilatON.Aggr, aes(x = Cut, y = freq,fill = light)) + 
  geom_bar(data = subset(spikesBilatClean.BilatON.Aggr, light == "Light"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.BilatON.Aggr, light == "Dark"), stat = "identity") + 
  scale_fill_manual(values=c("#949398FF","#F4DF4EFF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-250,250)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.5,0.5)) + 
  xlab("Latency, s")+
...
kruskal_effsize(data =spikesBilatClean.BilatOFF, maxOFFdelta~light)
kruskal_effsize(data =spikesBilatClean.BilatOFF, maxOFFdelta~paste(spikesBilatClean.BilatOFF$light,spikesBilatClean.BilatOFF$hemisph))
...
ggplot(spikesBilatClean.BilatOFF, aes(y=maxOFFdelta, x = light, fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
...
kruskal_effsize(data =spikesBilatClean.BilatOFF, maxBinOff~hemisph)
kruskal_effsize(data =spikesBilatClean.BilatOFF, maxBinOff~paste(spikesBilatClean.BilatOFF$light,spikesBilatClean.BilatOFF$hemisph))
...
spikesBilatClean.BilatOFF$Cut <- cut(spikesBilatClean.BilatOFF$maxBinOff, breaks = seq(0, max(spikesBilatClean.BilatOFF$maxBinOff+0.25), 0.05), right = FALSE) 

spikesBilatClean.BilatOFF.Aggr = spikesBilatClean.BilatOFF %>% 
  group_by(light, hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesBilatClean.BilatOFF.Aggr$n <- ifelse(spikesBilatClean.BilatOFF.Aggr$hemisph == "Left", -1*spikesBilatClean.BilatOFF.Aggr$n, spikesBilatClean.BilatOFF.Aggr$n)

spikesBilatClean.BilatOFF.Aggr$freq <- ifelse(spikesBilatClean.BilatOFF.Aggr$hemisph == "Left", -1*spikesBilatClean.BilatOFF.Aggr$freq, spikesBilatClean.BilatOFF.Aggr$freq)

ggplot(spikesBilatClean.BilatOFF.Aggr, aes(x = Cut, y = freq,fill = hemisph, alpha = light)) +
  facet_grid(.~light)+
  geom_bar(data = subset(spikesBilatClean.BilatOFF.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesBilatClean.BilatOFF.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  scale_alpha_discrete(range = c(1, 0.4))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.6,0.6)) + 
  xlab("Latency, s")+
  ylab("Proportion of units")+
  coord_flip()+
  theme_bw(base_size=20)+
  theme(panel.grid.major = element_blank(), axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))#legend.position = "none")
...
kruskal_effsize(data =spontFR.Contra, avgFR~light)
kruskal_effsize(data =spontFR.Contra, avgFR~paste(spontFR.Contra$light,spontFR.Contra$hemisph))
...
ggplot(spontFR.Contra, aes(y=avgFR, x = light, fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
...
kruskal_effsize(data =spikesContraClean.ContraON, maxONdelta~light)
kruskal_effsize(data =spikesContraClean.ContraON, maxONdelta~hemisph)
kruskal_effsize(data =spikesContraClean.ContraON, maxONdelta~paste(spikesContraClean.ContraON$light,spikesContraClean.ContraON$hemisph))
...
ggplot(spikesContraClean.ContraON, aes(y=maxONdelta, x = light, fill = hemisph, alpha=light))+
  #facet_grid(.~hemisph)+
  geom_split_violin(width=1)+
  #geom_boxplot(width=0.2,outlier.shape = NA)+
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
...
kruskal_effsize(data =spikesContraClean.ContraON, maxBin~light)
kruskal_effsize(data =spikesContraClean.ContraON, maxBin~hemisph)
kruskal_effsize(data =spikesContraClean.ContraON, maxBin~paste(spikesContraClean.ContraON$light,spikesContraClean.ContraON$hemisph))
...
spikesContraClean.ContraON$Cut <- cut(spikesContraClean.ContraON$maxBin, breaks = seq(0, max(spikesContraClean.ContraON$maxBin+0.25), 0.05), right = FALSE) 

spikesContraClean.ContraON.Aggr = spikesContraClean.ContraON %>% 
  group_by(light, hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesContraClean.ContraON.Aggr$n <- ifelse(spikesContraClean.ContraON.Aggr$hemisph == "Left", -1*spikesContraClean.ContraON.Aggr$n, spikesContraClean.ContraON.Aggr$n)

spikesContraClean.ContraON.Aggr$freq <- ifelse(spikesContraClean.ContraON.Aggr$hemisph == "Left", -1*spikesContraClean.ContraON.Aggr$freq, spikesContraClean.ContraON.Aggr$freq)

ggplot(spikesContraClean.ContraON.Aggr, aes(x = Cut, y = freq,fill = hemisph, alpha = light)) +
  facet_grid(.~light)+
  geom_bar(data = subset(spikesContraClean.ContraON.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesContraClean.ContraON.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  scale_alpha_discrete(range = c(1, 0.4))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.6,0.6)) + 
...
kruskal_effsize(data =spikesContraClean.ContraOFF, maxOFFdelta~light)
#kruskal_effsize(data =spikesContraClean.ContraOFF, maxBin~hemisph)
#kruskal_effsize(data =spikesContraClean.ContraON, maxBin~paste(spikesContraClean.ContraON$light,spikesContraClean.ContraON$hemisph))
...
#kruskal_effsize(data =spikesContraClean.ContraOFF, maxOFFdelta~light)
kruskal_effsize(data =spikesContraClean.ContraOFF, maxBinOff~hemisph)
#kruskal_effsize(data =spikesContraClean.ContraON, maxBin~paste(spikesContraClean.ContraON$light,spikesContraClean.ContraON$hemisph))
...
spikesContraClean.ContraOFF$Cut <- cut(spikesContraClean.ContraOFF$maxBinOff, breaks = seq(0, max(spikesContraClean.ContraOFF$maxBinOff)+0.025, 0.05), right = FALSE) 

spikesContraClean.ContraOFF.Aggr = spikesContraClean.ContraOFF %>% 
  group_by( hemisph, Cut) %>% 
  summarise(n = n()) %>%  mutate(freq = n / sum(n))

spikesContraClean.ContraOFF.Aggr$n <- ifelse(spikesContraClean.ContraOFF.Aggr$hemisph == "Left", -1*spikesContraClean.ContraOFF.Aggr$n, spikesContraClean.ContraOFF.Aggr$n)

spikesContraClean.ContraOFF.Aggr$freq <- ifelse(spikesContraClean.ContraOFF.Aggr$hemisph == "Left", -1*spikesContraClean.ContraOFF.Aggr$freq, spikesContraClean.ContraOFF.Aggr$freq)

ggplot(spikesContraClean.ContraOFF.Aggr, aes(x = Cut, y = freq,fill = hemisph)) + 
  geom_bar(data = subset(spikesContraClean.ContraOFF.Aggr, hemisph == "Left"), stat = "identity") + 
  geom_bar(data = subset(spikesContraClean.ContraOFF.Aggr, hemisph == "Right"), stat = "identity") + 
  scale_fill_manual(values=c("#FC766AFF","#5884B1FF"))+
  #scale_y_continuous(breaks = c(seq(-200,200,50)),labels = paste0(as.character(c(seq(200, 0, -50), seq(50, 200, 50)))), limits = c(-200,200)) + 
  scale_y_continuous(breaks = c(seq(-1,1,0.2)),labels = paste0(as.character(c(seq(-1, 0, 0.2), seq(0.2, 1, 0.2)))), limits = c(-0.4,0.4)) + 
  xlab("Latency, s")+
