...
AllDataRaw = read.table("VisCellsEntRaw.txt",sep="\t",header = T)
...
ggsave(file="Figure11_Ento_BilatneuronsContraON_peakLat_hist_hemisph.pdf", width = 10, height = 8)
...
ggsave(file="Figure12_Ento_BilatneuronsContraON_peakLat_hist_light.pdf", width = 10, height = 8)
...
ggsave(file="Figure50_Ento_BilatneuronsInhibit.pdf", width = 10, height = 8)
